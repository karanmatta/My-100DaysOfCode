...
//Logic:
//
// 1. Create a NumberFormat object using the getCurrencyInstance() method of the NumberFormat class.
// 2. Use the format() method of the NumberFormat class to format the payment.
// 3. Print the formatted payment.
//  